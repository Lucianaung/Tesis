...
uint8_t satA = 120;  // Start saturation at valueMin.
float valueMin = 10.0;  // Pulse minimum value (Should be less then valueMax).

uint8_t hueB = 140;  // End hue at valueMax.
uint8_t satB = 120;  // End saturation at valueMax.
